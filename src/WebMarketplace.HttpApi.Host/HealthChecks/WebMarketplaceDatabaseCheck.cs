...
public class WebMarketplaceDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public WebMarketplaceDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
