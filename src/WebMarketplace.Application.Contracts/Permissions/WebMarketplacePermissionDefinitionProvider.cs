...
public class WebMarketplacePermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        var vendorManagementGroup = context.AddGroup(WebMarketplacePermissions.VendorManagementGroup, L("Permission:VendorsManagementGroup"));
        var productsManagementGroup = context.AddGroup(WebMarketplacePermissions.ProductsManagementGroup,L("Permission:ProductsManagementGroup"));
        var ordersManagementGroup = context.AddGroup(WebMarketplacePermissions.OrdersManagementGroup, L("Permission:OrdersManagementGroup"));
        var cartsManagementGroup = context.AddGroup(WebMarketplacePermissions.CartsManagementGroup, L("Permission:CartsManagementGroup"));
        var reviewsManagementGroup = context.AddGroup(WebMarketplacePermissions.ReviewsManagementGroup, L("Permission:ReviewsManagementGroup"));

        //Define your own permissions here. Example:
        //myGroup.AddPermission(WebMarketplacePermissions.MyPermission1, L("Permission:MyPermission1"));
        
        var organizationPermission = vendorManagementGroup.AddPermission(
            WebMarketplacePermissions.Vendors.Default, L("Permission:Vendors"));
        organizationPermission.AddChild(
        ...
        var userOrganizationsPermission = vendorManagementGroup.AddPermission(
            WebMarketplacePermissions.UserVendors.Default, L("Permission:UserVendors"));
        userOrganizationsPermission.AddChild(
