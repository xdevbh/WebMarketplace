...
{
    [DbContext(typeof(WebMarketplaceDbContext))]
    [Migration("20241124173009_Added_Company_CompanyBlogPost")]
    partial class Added_Company_CompanyBlogPost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMarketplace.Addresses.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebMarketplace.Companies.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebMarketplace.Companies.CompanyBlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppCompanyBlogPosts", (string)null);
                });

            modelBuilder.Entity("WebMarketplace.Companies.CompanyImage", b =>
                {
                    b.Property<Guid>("CompanyId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("CompanyId", "BlobName");

                    b.HasIndex("CompanyId", "IsDefault")
                        .IsUnique()
                        .HasFilter("[IsDefault] = 1");

                    b.ToTable("AppCompanyImages", (string)null);
                });
            ...
            modelBuilder.Entity("WebMarketplace.Products.ProductImage", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ProductId", "BlobName");

                    b.ToTable("AppProductImages", (string)null);
                });

            modelBuilder.Entity("WebMarketplace.Products.ProductPrice", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebMarketplace.Products.ProductReview", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebMarketplace.Users.UserAddresses.UserAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebMarketplace.Companies.Company", b =>
                {
                    b.HasOne("WebMarketplace.Addresses.Address", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebMarketplace.Orders.Order", b =>
                {
                    ...
                    b.OwnsOne("WebMarketplace.Orders.Buyer", "Buyer", b1 =>
                        {
                    ...
                    b.OwnsOne("WebMarketplace.Orders.ShippingAddress", "ShippingAddress", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uniqueidentifier");
